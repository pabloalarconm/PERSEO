...
["this:$(uniqid)_Test","dcat:keyword","$(keyword)","xsd:string"],
...
["this:$(uniqid)_Test","dcat:version","$(version)","xsd:string"],
...
["this:$(uniqid)_Metric","dcat:keyword","$(keyword)","xsd:string"],
...
["this:$(uniqid)_Metric","dcat:version","$(version)","xsd:string"],
...
["this:$(uniqid)_Benchmark","dcat:keyword","$(keyword)","xsd:string"],
...
["this:$(uniqid)_Benchmark","dcat:version","$(version)","xsd:string"],
...
["this:$(uniqid)_Algorithm","dcat:keyword","$(keyword)","xsd:string"],
...
["this:$(uniqid)_Algorithm","dcat:version","$(version)","xsd:string"],
