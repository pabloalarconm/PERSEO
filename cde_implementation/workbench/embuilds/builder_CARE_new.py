...
["this:$(pid)_$(uniqid)_Concentration","sio:SIO_000221","this:$(pid)_$(uniqid)_Specification_unit","iri","this:$(uniqid)_Context"],
["this:$(pid)_$(uniqid)_Specific_process","sio:SIO_000325","this:$(pid)_$(uniqid)_Process","iri","this:$(uniqid)_Context"],


# Types
# ["this:$(pid)_Identifier","rdf:type","obo:NCIT_C164337","iri","this:$(uniqid)_Context"],
["this:$(pid)_Identifier","rdf:type","sio:SIO_000115","iri","this:$(uniqid)_Context"],
# ["this:$(pid)_Individual","rdf:type","obo:NCIT_C25190","iri","this:$(uniqid)_Context"],
...
["this:$(pid)_$(uniqid)_Specific_process","rdf:type","sio:SIO_000006","iri","this:$(uniqid)_Context"],
["this:$(pid)_$(uniqid)_Specific_process","rdf:type","$(specific_process_type)","iri","this:$(uniqid)_Context"],
...
["this:$(pid)_$(uniqid)_Specification_unit","rdf:type","sio:SIO_000074","iri","this:$(uniqid)_Context"],
["this:$(pid)_$(uniqid)_Specification_unit","rdf:type","$(concentration_unit_type)","iri","this:$(uniqid)_Context"],
...
["this:$(pid)_$(uniqid)_Specification_unit","rdfs:label","$(model) concentration specification unit","xsd:string", "this:$(uniqid)_Context"],
